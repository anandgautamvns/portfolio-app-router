...
export function Navigation() {
  return (
    <Disclosure as="nav" className="bg-white shadow header-container">
      {({ open }) => (
        <>
          <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 lg:divide-y lg:divide-gray-200">
            <div className="flex justify-between h-16">
              <div className="flex px-2 lg:px-0 gap-3">
                ...
                <div className="hidden lg:ml-6 lg:flex lg:space-x-8 gap-3">
                  <Link
